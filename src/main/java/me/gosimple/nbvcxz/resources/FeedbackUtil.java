...
public class FeedbackUtil
{
    ...
    private static Feedback getMatchFeedback(final Result result, final Match match)
    {
        ...
        if (match instanceof DictionaryMatch)
        {
            ...
            return new Feedback(configuration, warning, "feedback.dictionary.suggestions.allUppercase", "feedback.dictionary.suggestions.capitalization", "feedback.dictionary.suggestions.leet", "feedback.dictionary.suggestions.reversed", "feedback.extra.suggestions.addAnotherWord");
    ...
    {
        return new Feedback(configuration, "feedback.default.suggestions.useFewWords", "feedback.default.suggestions.noNeedSymbols");
    }
